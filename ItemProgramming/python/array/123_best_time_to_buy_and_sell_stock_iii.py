...
#Version: 0.1
#Purpose: 123_best_time_to_buy_and_sell_stock_iii.py
#Main logic principle:
#
#travel each element
#Usage:
#     example: python 123_best_time_to_buy_and_sell_stock_iii.py -in 1,2,3,4,5
############################################################################
"""
import os
import sys
...
class Solution:
	def __init__(self,arr):
		self.arr = arr
#profit DP
	def get_Best_Time_to_Buy_and_Sell_Stock_III_m1(self):
...
def call_main_steps():
	...
	ar_m1 = getArr.get_Best_Time_to_Buy_and_Sell_Stock_III_m1()
	print(ar_m1)
#
#main
############################################################################
